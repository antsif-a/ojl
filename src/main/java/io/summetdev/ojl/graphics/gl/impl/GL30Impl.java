...
public class GL30Impl extends GL20Impl implements io.summetdev.ojl.graphics.gl.GL30 {
    ...
    public void glDrawRangeElements(int mode, int start, int end, int count, int type, Buffer indices) {
        ...
        else throw new RuntimeException("Indices must be byte, short or int buffer");
    }
    ...
    public void glTexImage3D(int target, int level, int internalformat, int width, int height, int depth, int border, int format,
        ...
        if (pixels == null)
            ...
            GL12.glTexImage3D(target, level, internalformat, width, height, depth, border, format, type, bb);
        else if (pixels instanceof ShortBuffer sb)
            GL12.glTexImage3D(target, level, internalformat, width, height, depth, border, format, type, sb);
        else if (pixels instanceof IntBuffer ib)
            GL12.glTexImage3D(target, level, internalformat, width, height, depth, border, format, type, ib);
        else if (pixels instanceof FloatBuffer fb)
            GL12.glTexImage3D(target, level, internalformat, width, height, depth, border, format, type, fb);
    ...
    public void glTexSubImage3D(int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth,
        ...
        if (pixels instanceof ByteBuffer bb)
            GL12.glTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, bb);
        else if (pixels instanceof ShortBuffer sb)
            GL12.glTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, sb);
        else if (pixels instanceof IntBuffer ib)
            GL12.glTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, ib);
        else if (pixels instanceof FloatBuffer fb)
            GL12.glTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, fb);
        else if (pixels instanceof DoubleBuffer db)
